...
namespace NatCamU {
	...
	public class UnitygramBase : MonoBehaviour { //This class is easily subclassed and overriden
		...
		[NCDoc(145)] public ResolutionPreset PreviewResolution = ResolutionPreset.HD;
		[NCDoc(191)] public ResolutionPreset PhotoResolution = ResolutionPreset.HighestResolution;
		...
		public virtual void Start () {
			...
			NatCam.ActiveCamera.SetResolution(PreviewResolution);
			//Set the camera's photo resolution
			NatCam.ActiveCamera.SetPhotoResolution(PhotoResolution);
